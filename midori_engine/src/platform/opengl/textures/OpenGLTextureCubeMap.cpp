...
#define MD_CM_FRONT_EXT "_ft.tga"
#endif

#ifndef MD_CM_BACK_EXT
#define MD_CM_BACK_EXT "_bk.tga"
#endif

#ifndef MD_CM_LEFT_EXT
#define MD_CM_LEFT_EXT "_lf.tga"
#endif

#ifndef MD_CM_RIGHT_EXT
#define MD_CM_RIGHT_EXT "_rt.tga"
#endif

#ifndef MD_CM_UP_EXT
#define MD_CM_UP_EXT "_up.tga"
#endif

#ifndef MD_CM_DOWN_EXT
#define MD_CM_DOWN_EXT "_dn.tga"
#endif
...
namespace midori {
    ...
    OpenGLTextureCubeMap::OpenGLTextureCubeMap(const std::string& path) {
        ...
        BindTextureData(thisPath, extPtr, MD_CM_UP_EXT, GL_TEXTURE_CUBE_MAP_POSITIVE_Y);
        BindTextureData(thisPath, extPtr, MD_CM_DOWN_EXT, GL_TEXTURE_CUBE_MAP_NEGATIVE_Y);
